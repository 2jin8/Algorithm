...
public class Main {
	...
	static int[] dx = { 0, -1, 0 }, dy = { -1, 0, 1 }; // 좌, 상, 우
	...
	static int bfs() {
		int removeCnt = 0;
		int tmpEnemy = enemy; // ^^.. 초기화 조심하자

		Queue<Pos> queue = new ArrayDeque<>();
		int[][] tmpMap = copyArr();  // 초기화 조심하자
		while (tmpEnemy != 0) {
            ...
            // 위에서부터 덮어씌우면 기존 값이 날라가니 아래부터 덮어씌워야 함 (제발 조심하자)
